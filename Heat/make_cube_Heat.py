...
def main():
    ...
    data_files_8n = os.listdir('/home/michael/Desktop/Heat/8')
    data_files_5n = os.listdir('/home/michael/Desktop/Heat/5')
    data_files_2n = os.listdir('/home/michael/Desktop/Heat/2')
    data_files_0n = os.listdir('/home/michael/Desktop/Heat/0')  
    data_files_2s = os.listdir('/home/michael/Desktop/Heat/-2')
    data_files_5s = os.listdir('/home/michael/Desktop/Heat/-5')
    data_files_8s = os.listdir('/home/michael/Desktop/Heat/-8')
...
def extract_data(latitude, longitude, masked_value):
    ...
    filename = '/home/michael/Desktop/Heat/' + str(latitude) + '/' + str(longitude) + '.txt'
