...
def main():
    ...
    file_stem = '/home/michael/Desktop/git/Masters/trends/heat/'
    ...
    monthly_average_cube.rename('Average heat by month')
    ...
    variation_cube.rename('heat variations')
