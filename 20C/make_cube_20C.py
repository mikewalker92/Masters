...
def main():
    ...
    data_files_8n = os.listdir('/home/michael/Desktop/20C/8')
    data_files_5n = os.listdir('/home/michael/Desktop/20C/5')
    data_files_2n = os.listdir('/home/michael/Desktop/20C/2')
    data_files_0n = os.listdir('/home/michael/Desktop/20C/0')  
    data_files_2s = os.listdir('/home/michael/Desktop/20C/-2')
    data_files_5s = os.listdir('/home/michael/Desktop/20C/-5')
    data_files_8s = os.listdir('/home/michael/Desktop/20C/-8')
...
def extract_data(latitude, longitude, masked_value):
    ...
    filename = '/home/michael/Desktop/20C/' + str(latitude) + '/' + str(longitude) + '.txt'
