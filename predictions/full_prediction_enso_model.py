...
'''
isotherm_anomaly = iris.load_cube('/home/michael/Desktop/git/Masters/enso_model/enso_model.nc') * 100
...
all_cubes = [flux, flux_sst, flux_upwelling, cold_water_volume, H, sst, pressure, windspeed, heat, delta_pCO2, pCO2_air, pCO2_ocean, isotherm_anomaly]
